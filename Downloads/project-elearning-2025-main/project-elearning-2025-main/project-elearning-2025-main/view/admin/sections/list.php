...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center text-white" 
            ...
            <a href="/admin/sections/create" class="btn btn-secondary">
                ...
                <tbody>
                    <?php foreach ($sections as $section): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/admin/sections/edit/<?= $section['id'] ?>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Sửa
                                </a>
                                <a href="/admin/sections/delete/<?= $section['id'] ?>" 
