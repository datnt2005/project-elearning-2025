...
// api route section quiz
$router->addRoute('/admin/getSections', [$AdminQuiQuestionController, 'getSections']);
$router->addRoute('/admin/getQuizzes', [$AdminQuiQuestionController, 'getQuizzes']);
