                ...
                <tbody>
                    <?php foreach ($courses as $course): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/courses/edit/<?= $course['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Sửa</a>
                                <a href="/courses/delete/<?= $course['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa?');"><i class="fas fa-trash"></i> Xóa</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
