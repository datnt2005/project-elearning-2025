<?php
    ...
    class LessonController
    {
        ...
        public function index()
        {
            ...
            renderViewAdmin("view/lessons/list.php", ["lessons" => $lessons], "Lesson List");
        }

        public function createForm()
        {
            $sections = $this->sectionModel->getAllSections();
            renderViewAdmin("view/lessons/create.php", ["sections" => $sections], "Create Lesson");
        }
        ...
        public function editForm($id)
        {
            ...
            $sections = $this->sectionModel->getAllSections();
            renderViewAdmin("view/lessons/edit.php", [
                "lesson"   => $lesson,
                "sections" => $sections
            ], "Edit Lesson");
        }
