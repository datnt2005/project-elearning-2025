...
class SectionController
{
    ...
    public function index()
    {
        ...
        renderViewAdmin("view/sections/list.php", ["sections" => $sections], "Section List");
    }

    public function createForm()
    {
        $courses = $this->courseModel->getAllCourses();
        renderViewAdmin("view/sections/create.php", ["courses" => $courses], "Create Section");
    }
    ...
    public function editForm($id)
    {
        ...
        $courses = $this->courseModel->getAllCourses();
        renderViewAdmin("view/sections/edit.php", [
            "section" => $section,
            "courses" => $courses
        ], "Edit Section");
    }
