<h2>Thống kê đơn hàng hoàn thành theo tháng</h2>
                        ...
                        onClick: function(evt, activeElements) {
                            if (activeElements.length > 0) {
                                ...
                                fetch(`/admin/reports/completed-orders-detail-month?month=${selectedMonth}`)
                                    .then(response => response.json())
                                    .then(orderData => {
                                        console.log("Order Data:", orderData); // Kiểm tra dữ liệu trả về
                                        ...
                                        document.getElementById("modalMonth").innerText = selectedMonth;
                                        tableBody.innerHTML = "";
...
<div id="orderDetailsModal">
    <h3>Chi tiết đơn hàng tháng <span id="modalMonth"></span></h3>
