...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/courses/create" class="btn btn-add">
                        ...
                        <?php if (!empty($courses)): ?>
                            <?php foreach ($courses as $course): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/instructor/courses/edit/<?= $course['id'] ?>" class="btn btn-sm btn-outline-primary" title="Chỉnh sửa">
...
function confirmDelete(id) {
    if (confirm('Bạn có chắc chắn muốn xóa khóa học này?')) {
        window.location.href = '/instructor/courses/delete/' + id;
    }
}
