    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header d-flex justify-content-start align-items-center text-white">
                ...
                <a href="/instructor/post/create" class="btn btn-add">
                            ...
                            <?php if (!empty($posts)): ?>
                                <?php foreach ($posts as $post): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="/instructor/post/<?= $post['id'] ?>" 
                                                   class="btn btn-sm btn-outline-info" title="Xem">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="/instructor/post/edit/<?= $post['id'] ?>" 
    ...
    <script>
        function confirmDelete(id) {
            if (confirm('Bạn có chắc chắn muốn xóa bài viết này?')) {
                window.location.href = '/instructor/post/delete/' + id;
            }
        }
