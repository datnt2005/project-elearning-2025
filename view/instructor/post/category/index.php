...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/postCategory/create" class="btn btn-add">
                        ...
                        <?php if (!empty($postCategories)): ?>
                            <?php foreach ($postCategories as $postCategory): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/instructor/postCategory/edit/<?= $postCategory['id'] ?>" 
...
function confirmDelete(id) {
    if (confirm('Bạn có chắc chắn muốn xóa danh mục này?')) {
        window.location.href = '/instructor/postCategory/delete/' + id;
    }
}
