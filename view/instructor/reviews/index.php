...
<div class="container-fluid px-4">
    ...
    <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/reviews/create" class="btn btn-add">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/instructor/reviews/edit/<?= $review['id'] ?>" class="btn btn-sm btn-outline-primary"
                                title="Sửa">
...
function confirmDelete(id) {
    if (confirm('Bạn có chắc chắn muốn xóa bình luận này?')) {
        window.location.href = '/instructor/reviews/delete/' + id;
    }
}
