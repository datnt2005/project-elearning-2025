...
<div class="container-fluid px-4">
  ...
  <div class="card mb-4 shadow-sm">
    <div class="card-header d-flex justify-content-start align-items-center text-white">
      ...
      <a href="/instructor/lessons/create" class="btn btn-add">
            ...
            <?php if (!empty($lessons)): ?>
              <?php foreach ($lessons as $lesson): ?>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="/instructor/lessons/view/<?= $lesson['id'] ?>" 
                         class="btn btn-sm btn-outline-info" title="Xem">
                        <i class="fas fa-eye"></i>
                      </a>
                      <a href="/instructor/lessons/edit/<?= $lesson['id'] ?>" 
...
function confirmDelete(id) {
  if (confirm('Bạn có chắc chắn muốn xóa bài học này?')) {
    window.location.href = '/instructor/lessons/delete/' + id;
  }
}
