...
<div class="container-fluid px-4">
  ...
  <div class="card mb-4">
    <div class="card-header d-flex justify-content-start align-items-center text-white">
      ...
      <a href="/instructor/categories/create" class="btn btn-add">
            ...
            <?php if (!empty($categories)): ?>
              <?php foreach ($categories as $category): ?>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="/instructor/categories/<?= $category['id'] ?>" 
                         class="btn btn-sm btn-outline-info" title="Xem">
                        <i class="fas fa-eye"></i>
                      </a>
                      <a href="/instructor/categories/edit/<?= $category['id'] ?>" 
...
function confirmDelete(id) {
  if (confirm('Bạn có chắc chắn muốn xóa danh mục này?')) {
    window.location.href = '/instructor/categories/delete/' + id;
  }
}
