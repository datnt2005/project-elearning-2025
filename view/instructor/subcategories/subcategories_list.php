...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/subcategories/create" class="btn btn-add">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group table-actions">
                                        <a href="/instructor/subcategories/<?= $subcategory['id'] ?>" 
                                           class="btn btn-outline-info btn-sm" title="Xem">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/instructor/subcategories/edit/<?= $subcategory['id'] ?>" 
...
function confirmDelete(id) {
    if (confirm('Bạn có chắc chắn muốn xóa danh mục này?')) {
        window.location.href = '/instructor/subcategories/delete/' + id;
    }
}
