...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/sections/create" class="btn btn-add">
                        ...
                        <?php if (!empty($sections)): ?>
                            <?php foreach ($sections as $section): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/instructor/sections/view/<?= $section['id'] ?>" 
                                               class="btn btn-sm btn-outline-info" title="Xem">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="/instructor/sections/edit/<?= $section['id'] ?>" 
...
function confirmDelete(id) {
  if (confirm('Bạn có chắc chắn muốn xóa section này?')) {
    window.location.href = '/instructor/sections/delete/' + id;
  }
}
