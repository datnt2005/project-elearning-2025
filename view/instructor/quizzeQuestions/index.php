...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-start align-items-center text-white">
            ...
            <a href="/instructor/quizQuests/create" class="btn btn-add">
                        ...
                        <?php if (!empty($quizQuestions)): ?>
                            <?php foreach ($quizQuestions as $quiz): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/instructor/quizQuests/view/<?= $quiz['id'] ?>" 
                                               class="btn btn-sm btn-outline-info" title="Xem">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="/instructorinstructor/quizQuests/update/<?= $quiz['id'] ?>" 
...
function confirmDelete(id) {
    if (confirm('Bạn có chắc chắn muốn xóa câu hỏi này?')) {
        window.location.href = '/instructor/quizQuests/delete/' + id;
    }
}
